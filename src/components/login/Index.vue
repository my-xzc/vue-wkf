	...
	<form class="row">
		...
		<div class="col-xs-12">
			<div style="background-color:#ffffff;width:100%;text-align:center;">
				<input v-model="code" maxlength="4" class="login-input input login-short-txt" type="tel" placeholder="请输入验证码" style="width:59%;padding-left:3rem;text-align:center;"><b class="height-line"></b><a class="get-cout">
				<img v-on:click="flashVerifiImg" class="yzma-img" :src="verifiImg.img" style="width:6rem;height:2.5rem;margin-top:0.5rem;"></a>
			</div>
		</div>
		<div class="col-xs-12">
			<div class="container">
				<div class="checkbox">
					<label><input v-bind:checked="checked" v-on:change="checkAgree" id="checkbox" type="checkbox">我已同意</label> <a @click="showWX" style="color:#CC4441;" href="javascript:void(0);">《微信服务协议》</a>
				</div>
