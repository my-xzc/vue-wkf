...
//PRODUCTION 为一个全局变量
// if (PRODUCTION) {
// 	baseServiceUrl = 'http://wkf.hx168.com.cn/hxkf/api/v1.0/',
// 	jsonServiceUrl = 'http://wkf.hx168.com.cn/hxwt/servlet/json?';
// } else { 
	baseServiceUrl = 'http://wxtest.hx168.com.cn/hxkf/api/v1.0/',
